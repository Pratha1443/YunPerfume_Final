...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "YUN — Slow perfumery from India" },
      { name: "description", content: "YUN Fragrance Journey is a cinematic web experience for an Indian perfumery brand." },
      { property: "og:description", content: "YUN Fragrance Journey is a cinematic web experience for an Indian perfumery brand." },
      { name: "twitter:description", content: "YUN Fragrance Journey is a cinematic web experience for an Indian perfumery brand." },
    ],
