    ...
    <div className="bg-transparent noise min-h-screen pt-32 pb-32 md:pt-40">
      <div className="mx-auto max-w-md px-5 text-center">
        ...
        <p className="mt-8 leading-relaxed text-muted-foreground">
          Thank you for choosing YUN. Your order {orderId && <span className="font-mono text-foreground">#{orderId}</span>} has been received. 
          A confirmation email will reach your inbox shortly. 
        </p>
