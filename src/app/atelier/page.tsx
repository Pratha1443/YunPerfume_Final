...
export default function TheAtelier() {
  return (
    <div className="bg-ivory noise">
      {/* Hero */}
      <section className="pt-[22vh] pb-[14vh] px-5 md:px-10 max-w-[1400px] mx-auto">
      ...
      {/* Philosophy */}
      <section className="grid md:grid-cols-2 gap-0 border-y border-border/40">
        <div className="relative aspect-square md:aspect-auto">
          <Image src={botanyImg} alt="Botanicals at the studio" fill className="object-cover" />
        </div>
      ...
      {/* Craft */}
      <section className="py-[20vh] px-5 md:px-10 max-w-[1400px] mx-auto">
        ...
        <div className="grid md:grid-cols-12 gap-10 items-end">
          <div className="md:col-span-7">
            <div className="relative aspect-[16/9] bg-muted">
               <Image src={craftImg} alt="The crafting process" fill className="object-cover" />
            </div>
          </div>
      ...
      {/* Closing Quote */}
      <section className="py-[16vh] bg-ink text-ivory text-center px-5">
